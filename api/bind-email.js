...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const dupUrl = SUPABASE_URL + "/rest/v1/users?id=neq." + userId + "&email=eq." + encodeURIComponent(normalizedEmail) + "&select=id";
    ...
    const patchUrl = SUPABASE_URL + "/rest/v1/users?id=eq." + userId;
